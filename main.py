...
def train():
    ...
    brain = BrainDQN(numActions, numAPs, BUFFER_LEN, param_file=None)
...
def test():
    ...
    np.set_printoptions(threshold=5)           # Total number of array elements which trigger summarization rather than full repr
